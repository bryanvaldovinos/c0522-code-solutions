...
console.log('Author of JSON Syntax book:', bookshelf[1].author);
console.log('ISBN of Intro to JS Object Notation book:', bookshelf[0].isbn);
console.log('Full title of Build APIs book:', bookshelf[2].title);
